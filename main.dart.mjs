...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1289: (x0,x1) => x0.item(x1),
      _1290: () => new FileReader(),
      _1292: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1293: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1293(f,arguments.length,x0) }),
      _1294: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      ...
      _1342: Object.is,
      _1343: o => o instanceof Array,
      _1344: (a, i) => a.push(i),
      _1347: (a, l) => a.length = l,
      _1348: a => a.pop(),
      _1349: (a, i) => a.splice(i, 1),
      _1350: (a, s) => a.join(s),
      _1351: (a, s, e) => a.slice(s, e),
      _1353: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1354: a => a.length,
      _1355: (a, l) => a.length = l,
      _1356: (a, i) => a[i],
      _1357: (a, i, v) => a[i] = v,
      _1359: o => {
      ...
      _1362: o => o instanceof Uint8Array,
      _1363: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1364: o => o instanceof Int8Array,
      _1365: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1366: o => o instanceof Uint8ClampedArray,
      _1367: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1368: o => o instanceof Uint16Array,
      _1369: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1370: o => o instanceof Int16Array,
      _1371: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1372: o => o instanceof Uint32Array,
      _1373: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1374: o => o instanceof Int32Array,
      _1375: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1377: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1378: o => o instanceof Float32Array,
      _1379: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1380: o => o instanceof Float64Array,
      _1381: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1382: (t, s) => t.set(s),
      _1383: l => new DataView(new ArrayBuffer(l)),
      ...
      _1389: (b, o) => new DataView(b, o),
      _1390: (b, o, l) => new DataView(b, o, l),
      _1391: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1392: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1393: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1394: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1395: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1396: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1397: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1398: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1399: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1400: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1401: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1402: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1405: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1406: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1407: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1408: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1409: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1410: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1423: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1424: (handle) => clearTimeout(handle),
      _1425: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1426: (handle) => clearInterval(handle),
      _1427: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1428: () => Date.now(),
      _1433: o => Object.keys(o),
      _1435: x0 => x0.close(),
      _1436: () => new MessageChannel(),
      _1443: (x0,x1,x2) => x0.postMessage(x1,x2),
      _1444: (x0,x1) => x0.push(x1),
      ...
      _1452: (x0,x1,x2) => x0.postMessage(x1,x2),
      _1453: x0 => x0.terminate(),
      _1455: (x0,x1) => globalThis.Object.is(x0,x1),
      _1456: (x0,x1) => x0.at(x1),
      _1457: x0 => x0.entries(),
      _1458: x0 => x0.values(),
      _1459: x0 => globalThis.BigInt(x0),
      _1460: () => new Map(),
      _1461: (x0,x1,x2) => x0.set(x1,x2),
      _1462: () => new Set(),
      _1463: (x0,x1) => x0.add(x1),
      _1464: x0 => x0.toString(),
      _1465: x0 => x0.length,
      _1467: x0 => x0.buffer,
      _1468: (x0,x1,x2) => x0.transaction(x1,x2),
      _1469: (x0,x1) => x0.objectStore(x1),
      _1470: (x0,x1) => x0.getAllKeys(x1),
      _1471: (x0,x1) => x0.getAll(x1),
      _1473: (x0,x1) => x0.delete(x1),
      _1474: (x0,x1,x2) => x0.put(x1,x2),
      _1475: x0 => x0.clear(),
      _1476: x0 => x0.close(),
      _1478: (x0,x1,x2) => x0.open(x1,x2),
      _1479: (x0,x1) => x0.contains(x1),
      _1482: (x0,x1) => x0.createObjectStore(x1),
      ...
      _1498: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1499: (x0,x1) => globalThis.fetch(x0,x1),
      _1500: (x0,x1) => x0.get(x1),
      _1501: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1501(f,arguments.length,x0,x1,x2) }),
      _1502: (x0,x1) => x0.forEach(x1),
      _1503: x0 => x0.abort(),
      _1504: () => new AbortController(),
      _1505: x0 => x0.getReader(),
      _1506: x0 => x0.read(),
      _1507: x0 => x0.cancel(),
      ...
      _1525: x0 => x0.openCursor(),
      _1526: x0 => x0.continue(),
      ...
      _1541: (x0,x1) => x0.exec(x1),
      _1542: (x0,x1) => x0.test(x1),
      _1543: x0 => x0.pop(),
      _1545: o => o === undefined,
      _1547: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1549: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1550: o => o instanceof RegExp,
      _1551: (l, r) => l === r,
      _1552: o => o,
      _1553: o => o,
      _1554: o => o,
      ...
      _1556: o => o.length,
      _1558: (o, i) => o[i],
      _1559: f => f.dartFunction,
      _1560: () => ({}),
      _1561: () => [],
      _1563: () => globalThis,
      _1564: (constructor, args) => {
      ...
      _1566: (o, p) => o[p],
      _1567: (o, p, v) => o[p] = v,
      _1568: (o, m, a) => o[m].apply(o, a),
      _1570: o => String(o),
      _1571: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1572: o => {
      ...
      _1772: (x0,x1) => { x0.draggable = x1 },
      _1788: x0 => x0.style,
      _2717: (x0,x1) => { x0.accept = x1 },
      _2731: x0 => x0.files,
      _2757: (x0,x1) => { x0.multiple = x1 },
      _2775: (x0,x1) => { x0.type = x1 },
      _3494: () => globalThis.window,
      _3534: x0 => x0.self,
      _3538: x0 => x0.location,
      _3814: x0 => x0.indexedDB,
      _3840: x0 => x0.pathname,
      _3881: x0 => x0.filename,
      _3882: x0 => x0.lineno,
      _4027: x0 => x0.port1,
      _4028: x0 => x0.port2,
      _4031: (x0,x1) => { x0.onmessage = x1 },
      _4033: (x0,x1) => { x0.onmessageerror = x1 },
      _4099: (x0,x1) => { x0.onmessage = x1 },
      _4101: (x0,x1) => { x0.onmessageerror = x1 },
      _4103: (x0,x1) => { x0.onerror = x1 },
      _6054: x0 => x0.target,
      _6094: x0 => x0.signal,
      _6155: x0 => x0.firstChild,
      _6166: () => globalThis.document,
      _6586: (x0,x1) => { x0.id = x1 },
      _6613: x0 => x0.children,
      _7932: x0 => x0.value,
      _7934: x0 => x0.done,
      _8114: x0 => x0.size,
      _8115: x0 => x0.type,
      ...
      _8632: x0 => x0.status,
      _8633: x0 => x0.ok,
      _8634: x0 => x0.statusText,
      _8635: x0 => x0.headers,
      _8636: x0 => x0.body,
      _10092: x0 => x0.result,
      _10093: x0 => x0.error,
      _10098: (x0,x1) => { x0.onsuccess = x1 },
      _10100: (x0,x1) => { x0.onerror = x1 },
      _10104: (x0,x1) => { x0.onupgradeneeded = x1 },
      _10122: x0 => x0.version,
      _10123: x0 => x0.objectStoreNames,
      _10190: x0 => x0.key,
      _10193: x0 => x0.value,
      _11031: (x0,x1) => { x0.display = x1 },
